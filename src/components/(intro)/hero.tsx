        ...
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-20 mx-auto z-40 relative select-none">
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Transform recruitment with the power of AI, upload CVs and job descriptions to get instant compatibility scores. HireQ is the all-in-one solution for your recruitment and job needs.
                </p>
            </Container>
            <Container delay={0.2}>
